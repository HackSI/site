...
Object.keys(members).forEach(i => members[i].id = i);
...
module.exports = [
    ...
    },
    {
        ...
        handler: (req, res) => {
            ...
            res.view('board', { title: 'foundation board', currentYear: currentYear, members: board });
        }
    },
    {
        method: 'GET',
        ...
        handler: (req, res) => {
            ...
            res.view(`board-profile`, { title: 'foundation board', currentYear: currentYear, member: members[u], bio: members[u].bio });
        }
    },
    {
        method: 'GET',

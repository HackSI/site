...
module.exports = [
    ...
    },
    {
        ...
        path: '/register',
        handler: (req, res) => {
            res.redirect('https://hacksi2023.eventbrite.com');
        }
    },
    {
        method: 'GET',
    ...
    },
    {
        ...
        path: '/winner-winner',
        handler: (req, res) => {
            res.view('winner', { title: 'Winner', currentYear: currentYear, banners: getBanners() }, { layout: 'print' });
        }
    },
    {
        method: 'GET',
        path: '/press/release',
        handler: (req, res) => {
            res.view('press-release', { title: 'Press Release', currentYear: currentYear, banners: getBanners() }, { layout: 'print' });
        }
    },
    {
        method: 'GET',
    ...
    },
    {
        ...
        path: '/instagram',
        handler: (req, res) => {
            res.redirect('https://instagram.com/hacksi_org');
        }
    },
    {
        method: 'GET',
    ...
    },*/
    {
        ...
        path: '/workshop',
        handler: (req, res) => {
            res.redirect('https://forms.gle/cDk2nNimUFizNN7G9');
        }
    },
    {
        method: 'GET',
        path: '/tracker',
        handler: (req, res) => {
            res.redirect('https://forms.gle/d1y9YPK6hVi5WeXY9');
        }
    },
    {
        method: 'GET',
    ...
    },
    {
        ...
        path: '/survey',
        handler: (req, res) => {
            res.redirect('https://forms.gle/yibKrdqcTmnj2cgAA');
        }
    },
    {
        method: 'GET',

module.exports = [
    ...
    },
    {
        ...
        path: '/volunteer',
        handler: function (req, res) {
            res.redirect('https://docs.google.com/forms/d/1N4XyY-pbktXrqsyKu0cJC-VHYiQkL62reeEgD3yOD_A/viewform');
        }
    },
    {
        method: 'GET',
    ...
    },
    {
        ...
        path: '/tracker',
        handler: function (req, res) {
            res.redirect('https://docs.google.com/forms/d/1w6gWM1BaMJTOVdJG6F8aG8FGUX7tyGbZ9HMgXFRc5Zw');
        }
    }
]
